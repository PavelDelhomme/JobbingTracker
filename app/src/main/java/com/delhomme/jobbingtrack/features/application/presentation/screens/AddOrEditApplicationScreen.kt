package com.delhomme.jobbingtrack.features.application.presentation.screens
            ...
            onSubmit = { form ->
                ...
                val submitAction = {
                    ...
                    val entity = ApplicationEntity(
                        ...
                        platformRefId = form["platformId"]?.takeIf(String::isNotBlank),
                        contractTypeRefId = form["contractTypeId"]?.takeIf(String::isNotBlank),
                        location = form["location"]?.takeIf(String::isNotBlank),
                        typeRefId = form["applicationTypeId"]!!,
                        statusRefId = form["applicationStatusId"]!!,
